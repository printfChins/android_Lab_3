...
public class MainActivity extends AppCompatActivity {
    ...
    private void showToast(){
        ...
        View layout = inflater.inflate(R.layout.activity_toast_layout,(ViewGroup)findViewById(R.id.toast_layout_root));
    ...
    private  void showListDialog(){
        ...
        dialog_list.setItems(list, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                Toast.makeText(MainActivity.this,"你選的是"+list[which],Toast.LENGTH_SHORT).show();
            }
        });
        dialog_list.show();
    }
